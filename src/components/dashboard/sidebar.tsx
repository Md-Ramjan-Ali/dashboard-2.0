    ...
    <>
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          {/* Logo Section - Using custom logo.png */}
          <div className={cn(
            ...
            <div 
              className={cn("transition-all cursor-pointer", isSidebarOpen ? "flex-1" : "w-16")}
            ...
            >
                <div className="relative h-12 w-full cursor-pointer">
                  <Image 
                    ...
                    alt="Logo" 
                    fill
                    className={cn("object-contain transition-all duration-300", isSidebarOpen ? "object-left" : "object-center scale-125")}
                    priority
                  />
                </div>
            </div>
